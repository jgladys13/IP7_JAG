...
select last_name from sales_rep;
select sales_rep_num from sales_rep;
select city from sales_rep;
select customer_num from orders;
select order_num from orders;
select * from customers where sales_rep_num=20;
select customer_name, balance, credit_limit FROM customer where sales_rep_num=20;
Select part_num, num_ordered, quoted_price and total_price where total_price is (num_ordered * quoted_price) where only 1 num ordered and the order number is 21617;
select order_date from orders where order_date like "2010-10-20" and "2010-10-22";
select part_description from parts where part_description like "D%" and "%er";
